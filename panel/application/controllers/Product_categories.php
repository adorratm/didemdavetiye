    ...
    public function delete($id)
    {
        ...
        if (!empty($product_category)) :
            ...
            if ($delete) :
                 ...
                 */
                $products = $this->product_model->get_all(["category_id" => $id]);
                if (!empty($products)) :
                    $this->products->delete(["category_id" => $id]);
                    foreach ($products as $sKey => $sValue) :
                        $product_images = $this->product_image_model->get_all(["product_id" => $sValue->id]);
                        if (!empty($product_images)) :
                            $this->product_image_model->delete(["product_id" => $sValue->id]);
