...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
	<div class="row">
		<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
			<h4 class="mb-3">
				Ürün Listesi
				<a href="javascript:void(0)" data-url="<?= base_url("products/new_form"); ?>" class="btn btn-sm btn-outline-primary rounded-0 float-right createProductBtn"> <i class="fa fa-plus"></i> Ürün Ekle</a>
			</h4>
		</div>
		<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
...
<script>
	...
	$(document).ready(function() {
		$(document).on("click", ".createProductBtn", function(e) {
			...
			createModal("#productModal", "Ürün Ekle", "Ürün Ekle", 600, true, "20px", 0, "#e20e17", "#fff", 1040, function() {
		...
		$(document).on("click", ".btnSave", function(e) {
			...
			e.stopImmediatePropagation();
			let url = $(this).data("url");
			let formData = new FormData(document.getElementById("saveProduct"));
